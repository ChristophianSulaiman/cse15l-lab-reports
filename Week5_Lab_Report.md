# **This is my week 5 Lab Report**
**By Christophian Austin Sulaiman**


**I will be choosing the find command for this lab report**

3 Interesting command-line options or alternate ways to use the find command:
...
```
[cs15lfa22fp@ieng6-201]:docsearch:262$ find technical/plos -name "*.txt"
...
'''    
[cs15lfa22fp@ieng6-201]:docsearch:270$ find technical/plos/ -name "pmed.0020281.txt"
technical/plos/pmed.0020281.txt
```
Third example would be :
```
[cs15lfa22fp@ieng6-201]:docsearch:273$ find technical/plos/ -name "journal.pbio.0030137.txt"
technical/plos/journal.pbio.0030137.txt
```


**The command find -name finds a file(s) based on their file name. This is very useful if you are trying to search for a certain file name amongst thousands of other files such as in technical/.**


Second command-line options or alternate ways to use the less command:
would be using -size.

First example of using -size:
```
[cs15lfa22fp@ieng6-201]:docsearch:307$ find technical/ -size 1M
technical/
technical/911report
...
Second example of using -size:

```
[cs15lfa22fp@ieng6-201]:docsearch:308$ find technical/plos -size 1M
technical/plos
technical/plos/journal.pbio.0020001.txt
technical/plos/journal.pbio.0020010.txt
technical/plos/journal.pbio.0020012.txt
...
Third example of using -size would be:
```
[cs15lfa22fp@ieng6-201]:docsearch:309$ find technical/biomed -size 1M
technical/biomed
technical/biomed/1468-6708-3-1.txt
technical/biomed/1468-6708-3-10.txt
technical/biomed/1468-6708-3-3.txt
...
**The find -size command finds all files with the given amount of storage size. This is useful incase you'd want to remove files that take too much storage.**


The third and final command-line options or alternate ways to use the less command: is -type d


first example of using:
```
[cs15lfa22fp@ieng6-201]:docsearch:316$ find technical/biomed -type d
technical/biomed
```

second example of using:
```
[cs15lfa22fp@ieng6-201]:docsearch:317$ find technical/ -type d
technical/
technical/911report
technical/biomed
technical/government
...
Third example of using:
```
[cs15lfa22fp@ieng6-201]:docsearch:320$ find technical/plos -type d
technical/plos
```

**-Type d gives the type of directory for the given name. This is useful incase you'd want to search for a directory inside a directory, or to look for any directory at all.**